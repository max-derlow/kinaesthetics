...
let bodyParts = { //pls fix
    nose: {string:"nose", drawn:false},
 	leftEye: {string:"leftEye", drawn:false},
	rightEye: {string:"rightEye", drawn:false},
	leftEar: {string:"leftEar", drawn:false},
	rightEar: {string:"rightEat", drawn:false},
	leftShoulder: {string:"leftShoulder", drawn:false},
	rightShoulder: {string:"rightShoulder", drawn:false},
	leftElbow: {string:"leftElbow", drawn:false},
	rightElbow: {string:"rightElbow", drawn:false},
	leftWrist: {string:"leftWrist", drawn:false},
	rightWrist: {string:"rightWrist", drawn:false},
	leftHip: {string:"leftHip", drawn:false},
	rightHip: {string:"rightHip", drawn:false},
	leftKnee: {string:"leftKnee", drawn:false},
	rightKnee: {string:"rightKnee", drawn:false},
	leftAnkle: {string:"leftAnkle", drawn:false},
	rightAnkle: {string:"rightAnkle", drawn:false}
};
